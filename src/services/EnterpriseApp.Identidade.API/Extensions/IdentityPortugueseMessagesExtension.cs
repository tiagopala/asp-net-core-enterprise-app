...
namespace EnterpriseApp.Identidade.API.Extensions
{
    public class IdentityPortugueseMessagesExtension : IdentityErrorDescriber
    {
        ...
        public override IdentityError DuplicateUserName(string userName) { return new IdentityError { Code = nameof(DuplicateUserName), Description = $"User '{userName}' já está sendo utilizado." }; }
